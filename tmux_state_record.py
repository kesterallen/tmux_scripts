...
which is run by the list_tmux_panes method
...
Generated by this cronjob:
    ...
    tmux list-s && (python3 ~/src/tmux_scripts/tmux_state_record.py  >| ~/tmux_state.txt)
...
def list_tmux_panes() -> list[str]:
    # TODO: get the format argument for this from the Pane.
    # e.g. list_panes_cmd = ['tmux', Pane.list_command, Pane.list_command_args, Pane.list_format]
    list_panes_cmd = [
        "tmux",
        "list-p",
        "-aF",
...
def main():
    ...
    for tmux_pane in list_tmux_panes():
        ...
        csv.writer(sys.stdout).writerow(pane_info)
